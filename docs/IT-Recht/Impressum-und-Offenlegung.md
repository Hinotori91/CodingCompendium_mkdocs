...
<!-- - Die Angabe des Impressums in einer E-Mail ist erforderlich, damit Nutzer Kontakt zum Unternehmen aufnehmen können und um sicherzustellen, dass das Unternehmen für seine Aktivitäten verantwortlich gemacht werden kann. -->
- Die Angabe des Impressums in einer E-Mail ist erforderlich, damit Nutzer Kontakt zum Unternehmen aufnehmen können und um das Unternehmen für seine Aktivitäten verantwortlich zu machen.

# Eine Bäckerei betreibt eine kommerzielle Webseite, bietet auf dieser jedoch keine Waren an. Muss diese Webseite ein Impressum haben? Wenn ja, welche Inhalte muss dieses Impressum haben?
- Ja, Die Impressumspflicht gilt für alle Unternehmen, die eine Website betreiben, unabhängig davon, ob sie Waren oder Dienstleistungen anbieten.
...
- Das Impressum muss folgende Angaben enthalten:
  ...
  - Die Handelsregisternummer des Unternehmens (sofern vorhanden)
  - Die Umsatzsteuer-Identifikationsnummer des Unternehmens (sofern vorhanden)
  - Den Namen und die Anschrift des vertretungsberechtigten Organs des Unternehmens
  - Die zuständige Aufsichtsbehörde
  - Angaben zur Schlichtungsstelle
  - Angaben zur Nutzung von Cookies
  - Angaben zum Datenschutz

# Die Webseite der Bäckerei gibt nur Information über die Bäckerei, deren geographische Lage, die Öffnungszeiten und angebotene Produkte. Ist diese Webseite laut Mediengesetz als "kleine Webseite" oder als "große Webseite" einzustufen? Was muss diese Webseite im Impressum laut Mediengesetzt enthalten?
- Die Webseite der Bäckerei ist laut Mediengesetz als "kleine Webseite" einzustufen. 
  - Das liegt daran, dass die Webseite keine journalistischen Inhalte enthält.

- Das Impressum einer kleinen Webseite muss folgende Angaben enthalten:
  - Den Namen und die Anschrift des Medieninhabers
  - Die E-Mail-Adresse des Medieninhabers
  - Die zuständige Aufsichtsbehörde
  - Angaben zur Nutzung von Cookies
  - Angaben zum Datenschutz

# Im Mediengesetz wird im §24 das Impressum behandelt, das Mediengesetz fordert aber noch zusätzliche Informationen, die im §25 definiert sind. Diese Erweiterung des Impressum wird wie genannt?
- Wird als **erweitertes Impressum** bezeichnet
  - Das erweiterte Impressum muss von allen Medieninhabern veröffentlicht werden, die eine Website mit journalistischen Inhalten betreiben.

- Zu den Angaben, die im erweiterten Impressum enthalten sein müssen, gehören:
  - Der Name und die Anschrift des Medieninhabers
  - Die E-Mail-Adresse des Medieninhabers
  - Die zuständige Aufsichtsbehörde
  - Angaben zur Nutzung von Cookies
  - Angaben zum Datenschutz
  - Angaben zur Schlichtungsstelle
  - Angaben zur Verantwortlichkeit für journalistische Inhalte
  - Angaben zur Redaktion
  - Angaben zu den journalistischen Inhalten
  - Angaben zur Verlinkung
  - Angaben zur Werbung

# Im Impressum des Webauftritts einer Bäckerei (https://www.simhofer.at) finden sich unter anderem folgende Einträge - ordnen Sie die einzelnen Zeilen dem passenden Gesetz, von dem es gefordert wird, zu - also entweder "§ 14 UGB", "§ 5 ECG" oder "MedienG"
